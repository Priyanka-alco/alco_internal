...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { discount: @discount.discount, from_range: @discount.from_range, status: @discount.status, to_range: @discount.to_range } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { discount: @discount.discount, from_range: @discount.from_range, status: @discount.status, to_range: @discount.to_range } }
